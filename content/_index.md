      ...
      text: |
        <div style="display: flex; align-items: center; justify-content: space-between; padding: 20px; margin: 5px 0; background-color: #ffffff; border-radius: 10px;">
          <div style="flex: 1;">
            ...
            <p style="font-size: 22px; margin-bottom: 0; color: #666;">📍 Weiguang Life Science Park Building A1, 19th Floor, Shenzhen, Guangdong 518000</p>
          </div>
